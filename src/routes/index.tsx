...
const ManageRecharge = React.lazy(() => import('../pages/finance/manage-recharge'));
const Recharge = React.lazy(() => import('../pages/finance/recharge'));
const Chat = React.lazy(() => import('../pages/chat'));
const Complain = React.lazy(() => import('../pages/complain'));
const Posts = React.lazy(() => import('../pages/posts'));
const SaleReports = React.lazy(() => import('../pages/reports/sale-reports'));
const UsersReports = React.lazy(() => import('../pages/reports/users-reports'));
const ServiceReports = React.lazy(() => import('../pages/reports/service-reports'));
const GeneralConfig = React.lazy(() => import('../pages/configurations/general-config'));
const ProConfig = React.lazy(() => import('../pages/configurations/pro-config'));
...
const serviceRoutes: RoutesProps[] = [
    {
        path: '/service',
        name: 'Service',
        component: Service,
...
const complainRoutes: RoutesProps[] = [
    {
        path: '/complain',
        name: 'Complain',
        component: Complain,
...
const configRoutes: RoutesProps[] = [
    {
        ...
        children: [
            {
                path: '/configurations/general-config',
                name: 'General Configuration',
                component: GeneralConfig,
                route: PrivateRoute,
            },
            {
                path: '/configurations/pro-config',
