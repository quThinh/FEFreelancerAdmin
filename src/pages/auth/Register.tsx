...
// images
import logoDark from '../../assets/images/logo48.svg';
import logoLight from '../../assets/images/logo48.svg';
    ...
    return (
        <>
            ...
            <AuthLayout bottomLinks={<BottomLink />}>
                ...
                <p className="text-muted mt-1 mb-4">{t('Create a free account and start using Niubi')}</p>
